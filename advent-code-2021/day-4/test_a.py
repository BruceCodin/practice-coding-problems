...
from a import parse_lines, bingo_draws, define_boards, final_score, play_game, has_bingo
import pytest 
...
class TestPlayGameExample:
    def test_example_score(self):
        ...
        assert play_game(lines) == 4512

    def test_no_winner_raises_error(self):
        # A minimal input where NO board can ever win
        lines = [
            "1,2,3,4,5",  # draws
            "",
            "10 11 12 13 14",
        ...
        # Expect play_game() to raise RuntimeError
